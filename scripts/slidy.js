  ...
  add_toolbar: function () {
    var counter, page;
     ...
     if (this.ns_pos || !this.ie6)
     {
       ...
       var gap1a = document.createTextNode(" | ");
       left.appendChild(gap1a);

       var contentsa = this.create_element("a");
       contentsa.setAttribute("href", "javascript: location.reload(0); ");
       contentsa.setAttribute("title", "reload (při problémech se zobrazováním matematiky)");
       contentsa.innerHTML = "reload (při problémech se zobrazováním matematiky)";
       left.appendChild(contentsa);
