...
{\itshape Určitý integrál} funkce $f(x)$ na intervalu $[a, b]$ je definován jako nárůst primitivní funkce 
...
Další využití určitého integrálu spočívá v možnosti nalézt jakousi průměrnou hodnotu funkce $f(x)$ na intervalu $[a,b]$. Tato hodnota se nazývá \emph{střední hodnota funkce} a je definována vztahem
