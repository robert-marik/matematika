...
Člen na levé straně rovnice představuje změnu stavové veličiny v čase.
První člen na pravé straně rovnice představuje přírůstek stavové veličiny za jednotku času 
vygenerovaný zdrojem (kladná hodnota) nebo ztracený ve spotřebiči (záporná hodnota).
Druhý člen na pravé straně rovnice představuje změnu stavové veličiny v důsledku toku
stavové veličiny prostorem. Záporné znaménko před operátorem divergence
...
je prostředí homogenní a materiálové vlastnosti nezávisí na stavu systému popsaném
stavovou veličinou \(u\).
